...
OpenGLShaderVariation::OpenGLShaderVariation() {
    m_program = 0;
...
void OpenGLShaderVariation::Bind() {
...
void OpenGLShaderVariation::Unbind() {
    GL_CHECK(glUseProgram(0));
}

int OpenGLShaderVariation::_var(std::string name, bool uniform) {
...
int OpenGLShaderVariation::Uniform(std::string name) {
    return(_var(name, true));
}

int OpenGLShaderVariation::Attribute(std::string name) {
    return(_var(name, false));
}

void OpenGLShaderVariation::Set(std::string name, float value) {
...
void OpenGLShaderVariation::Set(std::string name, vector3 value) {
    char* cname = (char*)name.c_str();
    int location = Uniform(cname);
    if (location < 0) {
        location = Attribute(cname);
...
void OpenGLShaderVariation::Set(std::string name, vector2 value) {
    char* cname = (char*)name.c_str();
    int location = Uniform(cname);
    if (location < 0) {
        location = Attribute(cname);
...
void OpenGLShaderVariation::Set(std::string name, vector4 value) {
    char* cname = (char*)name.c_str();
    int location = Uniform(cname);
    if (location < 0) {
        location = Attribute(cname);
...
void OpenGLShaderVariation::Set(std::string name, int value) {
    char* cname = (char*)name.c_str();
    int location = Uniform(cname);
    if (location < 0) {
        location = Attribute(cname);
...
void OpenGLShaderVariation::Set(std::string name, unsigned int value) {
    char* cname = (char*)name.c_str();
    int location = Uniform(cname);
    if (location < 0) {
        location = Attribute(cname);
...
void OpenGLShaderVariation::Set(std::string name, matrix4 value) {
    char* cname = (char*)name.c_str();
    int location = Uniform(cname);
    if (location < 0) {
        location = Attribute(cname);
